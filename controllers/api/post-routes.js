...
router.get('/', (req, res) => {
    ...
    Post.findAll({
      ...
      // we'll include the JOIN to the User table. We do this
      // by adding the property include, as shown in the following code:
      include: [
          {
            model: User,
            attributes: ['username']
          ...
          // the Comment model includes reference to the username field
          // from the User model
          {
            model: Comment,
